...
<link href="/thinkPHP/Public/css/form.css" rel="stylesheet" type="text/css" media="all" />
...
<div class="header_top">
	...
	<div class="head-bann">
		<div class="container">
			...
			<li class="grid"><a class="color2" href="women.html">Men's</a>
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
					...
					<div class="row">
						<div class="col1">
							<div class="h_nav">
								<h4>shop</h4>
								<ul>
									<li><a href="/as/women.html">men</a></li>
									<li><a href="women.html">women</a></li>
									<li><a href="women.html">kids</a></li>
									<li><a href="women.html">sports</a></li>
									<li><a href="women.html">brands</a></li>
...
<h3 class="new-models">featured products</h3>
			<ul id="flexiselDemo3">
				<li>
					...
					<img src="/thinkPHP/Public/images/shoes/1.jpg" class="img-responsive" alt="" class="veiw-img">
				...
				<li>
					<div class="biseller-column">
					<img src="/thinkPHP/Public/images/shoes/2.jpg" class="img-responsive" alt="" class="veiw-img">
						<a href="#"><i class="new"></i></a>
					<div class="biseller-name">
						<h4>Sample Item Title</h4>
						<p>$99.99</p>
				...
				<li>
					<div class="biseller-column">
					<img src="/thinkPHP/Public/images/shoes/3.jpg" class="img-responsive" alt="" class="veiw-img">
						<a href="#"><i class="new"></i></a>
					<div class="biseller-name">
						<h4>Sample Item Title</h4>
						<p>$99.99</p>
			...
			<script type="text/javascript">
			   ...
			   <script type="text/javascript" src="/thinkPHP/Public/js/jquery.flexisel.js"></script>
				...
				<div class="best-seller">
					...
					<ul id="flexiselDemo1">
						<li>
							<div class="biseller-column">
							<img src="/thinkPHP/Public/images/shoes/ss6.jpg" class="img-responsive" alt="">
							<a href="#"><i class="new"></i></a>
					<div class="biseller-name">
						<h4>Sample Item Title</h4>
						<p>$99.99</p>
						...
						<li>
							<div class="biseller-column">
							<img src="/thinkPHP/Public/images/shoes/ss4.jpg" class="img-responsive" alt="">
							<a href="#"><i class="new"></i></a>
					<div class="biseller-name">
						<h4>Sample Item Title</h4>
						<p>$99.99</p>
						...
						<li>
							<div class="biseller-column">
							<img src="/thinkPHP/Public/images/shoes/ss5.jpg" class="img-responsive" alt="">
							<a href="#"><i class="new"></i></a>
					<div class="biseller-name">
						<h4>Sample Item Title</h4>
						<p>$99.99</p>
			   ...
			   <div class="best-seller">
					...
					<ul id="flexiselDemo5">
						<li>
							...
							<img src="/thinkPHP/Public/images/shoes/ss3.jpg" class="img-responsive" alt="">
							<a href="#"><i class="new"></i></a>
					<div class="biseller-name">
						<h4>Sample Item Title</h4>
						<p>$99.99</p>
						...
						<li>
							<div class="biseller-column1">
							<img src="/thinkPHP/Public/images/shoes/ss1.jpg" class="img-responsive" alt="">
							<a href="#"><i class="new"></i></a>
					<div class="biseller-name">
						<h4>Sample Item Title</h4>
						<p>$99.99</p>
						...
						<li>
							<div class="biseller-column1">
							<img src="/thinkPHP/Public/images/shoes/ss2.jpg" class="img-responsive" alt="">
							<a href="#"><i class="new"></i></a>
					<div class="biseller-name">
						<h4>Sample Item Title</h4>
						<p>$99.99</p>
