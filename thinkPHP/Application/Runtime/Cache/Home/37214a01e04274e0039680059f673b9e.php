...
<link rel="stylesheet" href="/thinkPHP/Public/css/etalage.css">
...
<div class="col-md-9">
						...
						<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="/thinkPHP/Public/images/shoes/d1.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="/thinkPHP/Public/images/shoes/d1.jpg" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="/thinkPHP/Public/images/shoes/d2.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="/thinkPHP/Public/images/shoes/d2.jpg" class="img-responsive" title="" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="/thinkPHP/Public/images/shoes/d3.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="/thinkPHP/Public/images/shoes/d3.jpg"class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="/thinkPHP/Public/images/shoes/d4.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="/thinkPHP/Public/images/shoes/d4.jpg"class="img-responsive"  />
							</li>
						</ul>
						 <div class="clearfix"></div>		
				  </div>
				  <div class="desc1 span_3_of_2">
					...
					<div class="det_nav">
						...
						<ul>
							<li><a href="#"><img src="/thinkPHP/Public/images/shoes/1.jpg" class="img-responsive" alt=""/></a></li>
							<li><a href="#"><img src="/thinkPHP/Public/images/shoes/12.jpg" class="img-responsive" alt=""/></a></li>
							<li><a href="#"><img src="/thinkPHP/Public/images/shoes/3.jpg" class="img-responsive" alt=""/></a></li>
							<li><a href="#"><img src="/thinkPHP/Public/images/shoes/ss2.jpg" class="img-responsive" alt=""/></a></li>
						</ul>
					</div>
					<div class="det_nav1">
						<h4>Select a size :</h4>
