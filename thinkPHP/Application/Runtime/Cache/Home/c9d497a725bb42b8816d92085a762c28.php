  ...
  <div class="men">
      ...
      <div class="col-md-9 single_top">
         ...
         <div class="product-count">Showing 1 - 4 of 4 items</div>
          <div class="brand_box">
	         <div class="left-side col-xs-12 col-sm-3">
				 <img src="/thinkPHP/Public/images/shoes/2nd-day.jpg" alt=""/>
			 </div>
		  ...
		  <div class="brand_box">
	         <div class="left-side col-xs-12 col-sm-3">
				 <img src="/thinkPHP/Public/images/shoes/weekday1.jpg" alt=""/>
			 </div>
		     <div class="middle-side col-xs-12 col-sm-5">
		     	<h4><a href="#">Lorem Ipsum</a></h4>
		     	<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim</p>
		  ...
		  <div class="brand_box">
	         <div class="left-side col-xs-12 col-sm-3">
				 <img src="/thinkPHP/Public/images/shoes/g-star-raw.jpg" alt=""/>
			 </div>
		     <div class="middle-side col-xs-12 col-sm-5">
		     	<h4><a href="#">Lorem Ipsum</a></h4>
		     	<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim</p>
		...
		<div class="col-md-3 brand-left">
	      ...
	      <ul class="product">
	      	<li class="product_img"><img src="/thinkPHP/Public/images/shoes/10.jpg" class="img-responsive" alt=""/></li>
	      ...
	      <ul class="product">
	      	<li class="product_img"><img src="/thinkPHP/Public/images/shoes/9.jpg" class="img-responsive" alt=""/></li>
	      	<li class="product_desc">
	      		<h4><a href="#">quod mazim</a></h4>
	      		<p class="single_price">$66.30</p>
	      		<a href="#" class="link-cart">Add to Wishlist</a>
	      ...
	      <ul class="product">
	      	<li class="product_img"><img src="/thinkPHP/Public/images/shoes/8.jpg" class="img-responsive" alt=""/></li>
	      	<li class="product_desc">
	      		<h4><a href="#">quod mazim</a></h4>
	      		<p class="single_price">$66.30</p>
	      		<a href="#" class="link-cart">Add to Wishlist</a>
	      ...
	      <ul class="product">
	      	<li class="product_img"><img src="/thinkPHP/Public/images/shoes/7.jpg" class="img-responsive" alt=""/></li>
	      	<li class="product_desc">
	      		<h4><a href="#">quod mazim</a></h4>
	      		<p class="single_price">$66.30</p>
	      		<a href="#" class="link-cart">Add to Wishlist</a>
